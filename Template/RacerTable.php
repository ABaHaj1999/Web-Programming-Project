    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) { 
            ...
            <tr>
                ...
                <!-- <td><a href="deleteRacer.php?RacerID=<?php echo $row['RacerID']; ?>; ?>">Delete</a></td> -->
                <!-- <td><a href="updateRacer.php?RacerID=<?php echo $row['RacerID']; ?>?vendorid=<?php echo $row['vendorid']; ?>">Update</a></td> -->
            </tr>
        <?php } ?>
    </tbody>
</table>